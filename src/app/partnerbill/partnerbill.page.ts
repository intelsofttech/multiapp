...
@Component({
  selector: 'app-partnerbill',
  templateUrl: './partnerbill.page.html',
  styleUrls: ['./partnerbill.page.scss'],
})
export class PartnerbillPage implements OnInit {
 ...
 onList(){
	   ...
	   let postData = {
		...
		if(this.param2=="COUNTED"){
			this.httpClient.get(this.REST_API_SERVER+"/bills/type/counted/partnercode/"+this.param1+"/"+this.counted+"/"+this.param5, {headers: header})
				.subscribe(data => {
					console.log(data);
					this.results = data;
			...
			this.httpClient.get(this.REST_API_SERVER+"/bills/type/categ/partnercode/"+this.param1+"/"+this.param2+"/"+this.param5, {headers: header})
				.subscribe(data => {
					console.log(data);
					this.results = data;
