...
@Component({
  selector: 'app-listecotisations',
  templateUrl: './listecotisations.page.html',
  styleUrls: ['./listecotisations.page.scss'],
})
export class ListecotisationsPage implements OnInit {
 ...
 constructor(public alertCtrl: AlertController,
  ...
  onAdd(): any{
	  ...
	  if (!this.categForm.valid) {
	   ...
	   const compte = this.categForm.get('compte')?.value;
	   this.isSend = true;
 ...
 onChange(){
	...
	this.onGetConfigLabel(this.compte);
 }
 onList(){
		var header = {
			'Content-Type': 'application/json',
