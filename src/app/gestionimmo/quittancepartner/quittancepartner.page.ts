...
@Component({
  selector: 'app-quittancepartner',
  templateUrl: './quittancepartner.page.html',
  styleUrls: ['./quittancepartner.page.scss'],
})
export class QuittancepartnerPage implements OnInit {
