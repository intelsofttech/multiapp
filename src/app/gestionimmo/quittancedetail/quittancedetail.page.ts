...
@Component({
  selector: 'app-quittancedetail',
  templateUrl: './quittancedetail.page.html',
  styleUrls: ['./quittancedetail.page.scss'],
})
export class QuittancedetailPage implements OnInit {
