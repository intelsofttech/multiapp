...
onList(){
	   ...
	   let postData = {
		...
		if(this.param1=="0"){
			this.Url=this.REST_API_SERVER+"/apartmentselect/apikey";
		}else{
			this.Url=this.REST_API_SERVER+"/apartmentselect/apikey/selectid/"+this.param1;
		}
		this.httpClient.get(this.Url, {headers: header})
			.subscribe(data => {
				console.log(data);
				this.results = data;
				this.alllist = data;
