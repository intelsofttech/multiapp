...
@Component({
  selector: 'app-editemploienseignone',
  templateUrl: './editemploienseignone.page.html',
  styleUrls: ['./editemploienseignone.page.scss'],
})
export class EditemploienseignonePage implements OnInit {
 ...
 constructor(public alertCtrl: AlertController,
  ...
  ngOnInit() {
   ...
   onHoraire(){
		...
		this.httpClient.get(this.REST_API_SERVER+"/configs/compte/ensid/"+this.typeemlpoi+"/"+this.param1+"/horaire/"+this.param2, {headers: header})
			.subscribe(data => {
				console.log(data);
