...
export class StudentPage implements OnInit {
 ...
 constructor(public uploadService: UploadFileService,
  ...
  ngOnInit() {
	...
	this.classselected = this.param2;
	this.onListfliere();
	this.onClasse();
	this.onList();
		...
		if(this.classselected=="0"){
			if(this.level=="0"){
				if(this.filiere=="0"){
					...
					this.httpClient.get(this.REST_API_SERVER+"/users/group1/"+this.usergroup+"/"+this.filiere, {headers: header})
						.subscribe(data => {
							this.results = data;
							this.alllist = data;
							console.log(data);
				...
				this.httpClient.get(this.REST_API_SERVER+"/users/group2/"+this.usergroup+"/"+this.level, {headers: header})
					.subscribe(data => {
							this.results = data;
							this.alllist = data;
							console.log(data);
			...
			this.httpClient.get(this.REST_API_SERVER+"/users/group3/"+this.usergroup+"/"+this.classselected, {headers: header})
				.subscribe(data => {
							this.results = data;
							this.alllist = data;
							console.log(data);
