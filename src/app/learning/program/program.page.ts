...
export class ProgramPage implements OnInit {
  ...
  onAdd(): any{
	  ...
	  if (!this.categForm.valid) {
	   ...
	   if(this.id=="0"){
			...
			this.httpClient.post(this.REST_API_SERVER+"/program", postData, {headers: header})
			.subscribe(data => {
					console.log(data);
					this.onList();
					this.addForm = false;
		   ...
		   this.httpClient.put(this.REST_API_SERVER+"/program/"+this.id, postData, {headers: header})
				.subscribe(data => {
					console.log(data);
					this.onList();
					this.addForm = false;
 ...
 onList(){
	   ...
	   let postData = {
		...
		this.httpClient.get(this.REST_API_SERVER+"/programs/materialcode/"+this.param1+"/"+this.param2, {headers: header})
			.subscribe(data => {
				console.log(data);
				this.results = data;
				this.alllist = data;
 ...
 onDelete(id:string){
	   ...
	   let postData = {
		...
		this.httpClient.delete(this.REST_API_SERVER+"/program/"+id, {headers: header})
			.subscribe(data => {
				console.log(data);
				this.onList();
			}, error => {
 ...
 onGet(id:string){
	   ...
	   let postData = {
		...
		this.httpClient.get(this.REST_API_SERVER+"/program/"+id, {headers: header})
			.subscribe(data => {
				console.log(data);
				this.addForm = true;
