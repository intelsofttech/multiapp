...
@Component({
  selector: 'app-partnermodal',
  templateUrl: './partnermodal.page.html',
  styleUrls: ['./partnermodal.page.scss'],
})
export class PartnermodalPage implements OnInit {
 ...
 constructor(public alertCtrl: AlertController,
  ...
  ngOnInit() {
	...
	this.param3=  this.params.get('param2');
