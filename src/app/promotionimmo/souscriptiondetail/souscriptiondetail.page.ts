...
@Component({
  selector: 'app-souscriptiondetail',
  templateUrl: './souscriptiondetail.page.html',
  styleUrls: ['./souscriptiondetail.page.scss'],
})
export class SouscriptiondetailPage implements OnInit {
