...
@Component({
  selector: 'app-selectproprietaire',
  templateUrl: './selectproprietaire.page.html',
  styleUrls: ['./selectproprietaire.page.scss'],
})
export class SelectproprietairePage implements OnInit {
